...
setup(
    ...
    version='3.0.1rc1',  # Required

    # This is a one-line description or tagline of what your project does. This
    # corresponds to the "Summary" metadata field:
    # https://packaging.python.org/specifications/core-metadata/#summary
    description='Base pyworkflow plugin for Electron Diffraction image processing',  # Required
    ...
    url='https://github.com/scipion-ed/scipion-ed',  # Optional
    ...
    project_urls={  # Optional
        'Bug Reports': 'https://github.com/scipion-ed/scipion-ed/issues',
        'Source': 'https://github.com/scipion-ed/scipion-ed/',
    },
)
